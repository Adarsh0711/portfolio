...
const education = {
  title: "My education",
  description: "Through rigorous coursework and hands-on projects, I have developed a deep understanding of computer science principles and applications.",
  items: [
    {
...
const skills = {
  title: "My skills",
  description: "Equipped with a robust toolkit of technologies, I am prepared to contribute to innovative solutions in any environment.",
  categories: [
    {
    ...
    >
      <div className="container mx-auto">
        <Tabs defaultValue="experience" className="flex flex-col xl:flex-row gap-[60px]">
          ...
          <div className="min-h-[70vh] w-full experience-container">
              ...
              <div className="flex flex-col gap-[30px] text-center xl:text-left">
                ...
                <ScrollArea className="h-[400px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    <li className="bg-[#e5e7eb] h-auto py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1 col-span-2 experience-item">
                    ...
                    <li className="bg-[#e5e7eb] h-[250px] py-8 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1 experience-item">
                ...
                <ScrollArea className="h-[400px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {education.items.map((item, index) => (
                      <li key={index} className="bg-[#e5e7eb] h-[250px] py-8 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1 education-item">
                  ...
                  <div key={index}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {category.skills.map((skill, idx) => (
                        <div key={idx} className="bg-white border border-gray-300 p-4 rounded text-center skill-item">
